...
# Renault is currently identified through legacy CAN fingerprints only, as UDS
# sweep over OBD-II is blocked by SGW. Keep an empty FW_QUERY_CONFIG so shared
# firmware tests and tooling can treat the brand consistently.
